 ...
 */
package com.chimelong.test.setup;
...
import com.chimelong.test.constants.ChimelongTestConstants;
import com.chimelong.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ChimelongTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/chimelongtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/chimelongtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/chimelongtest/import/cstickets.impex");
			...
			importImpexFile(context, "/chimelongtest/import/csquotes.impex");
		}
	}
}
