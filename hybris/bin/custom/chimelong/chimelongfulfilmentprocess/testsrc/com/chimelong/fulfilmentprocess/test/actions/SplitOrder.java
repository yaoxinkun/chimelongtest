 ...
 */
package com.chimelong.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ChimelongFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ChimelongFulfilmentProcessConstants.PARENT_PROCESS);
