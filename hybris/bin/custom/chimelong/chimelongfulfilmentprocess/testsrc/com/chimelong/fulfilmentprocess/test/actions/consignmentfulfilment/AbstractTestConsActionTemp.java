 ...
 */
package com.chimelong.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, ChimelongFulfilmentProcessConstants.PARENT_PROCESS);
