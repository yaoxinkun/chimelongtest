 ...
 */
package com.chimelong.cockpits.setup;
...
import com.chimelong.cockpits.constants.ChimelongCockpitsConstants;
 ...
 */
@SystemSetup(extension = ChimelongCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ChimelongCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ChimelongCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ChimelongCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/chimelongcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
