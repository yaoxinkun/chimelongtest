 ...
 */
package com.chimelong.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("chimelongcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("chimelongcockpits.product.externalTaxes"));
